...
import examples.pattern._01_Creational._03_Builder._00_Theory.Paths.ZhopaPath;

public class ZhopaBuilder extends PathBuilder {
    private String to;
    private String from;
    ...
    public PathIF getPath() {
        return new ZhopaPath(to, from, subject, getSpeed());
    }
}
